...
1. Merge changes to development branch. Because this is a [named environment branch](../_3rdparty/docs/FAQ.md#what-is-a-named-branch),
...
1. Merge changes to production branch. Because this is a [named environment branch](../_3rdparty/docs/FAQ.md#what-is-a-named-branch),
   pushing to this branch triggers both _terraform plan_ and _terraform apply_. Review the apply output in your cloud build project https://console.cloud.google.com/cloud-build/builds;region=DEFAULT_REGION?project=YOUR_CLOUD_BUILD_PROJECT_ID
...
See `0-bootstrap` [README-Jenkins.md](../0-bootstrap/cicd-jenkins.wip/README-Jenkins.md#deploying-step-2-environments)
