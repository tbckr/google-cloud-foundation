...
step also configures a <a href="../_3rdparty/docs/GLOSSARY.md#foundation-cicd-pipeline">CI/CD Pipeline</a> for foundations code in subsequent
stages.</td>
</tr>
<tr>
...
<tr>
<td><a href="../../original-foundation/4-projects">4-projects</a></td>
<td>Sets up a folder structure, projects, and application infrastructure pipeline for applications,
 which are connected as service projects to the shared VPC created in the previous stage.</td>
</tr>
<tr>
<td><a href="../../original-foundation/5-app-infra">5-app-infra</a></td>
...
Please refer to [troubleshooting](../_3rdparty/docs/TROUBLESHOOTING.md) if you run into issues during this step.
...
1. Push your plan branch to trigger a plan for all environments. Because the
   _plan_ branch is not a [named environment branch](../_3rdparty/docs/FAQ.md#what-is-a-named-branch)), pushing your _plan_
...
1. Merge changes to production. Because this is a [named environment branch](../_3rdparty/docs/FAQ.md#what-is-a-named-branch),
...
1. Merge changes to development. Because this is a [named environment branch](../_3rdparty/docs/FAQ.md#what-is-a-named-branch),
   pushing to this branch triggers both _terraform plan_ and _terraform apply_. Review the apply output in your Cloud Build project https://console.cloud.google.com/cloud-build/builds;region=DEFAULT_REGION?project=YOUR_CLOUD_BUILD_PROJECT_ID
...
1. Merge changes to non-production. Because this is a [named environment branch](../_3rdparty/docs/FAQ.md#what-is-a-named-branch),
   pushing to this branch triggers both _terraform plan_ and _terraform apply_. Review the apply output in your Cloud Build project https://console.cloud.google.com/cloud-build/builds;region=DEFAULT_REGION?project=YOUR_CLOUD_BUILD_PROJECT_ID
...
1. You can now move to the instructions in the [4-projects](../../original-foundation/4-projects/README.md) step.

### Deploying with Jenkins

See `0-bootstrap` [README-Jenkins.md](../0-bootstrap/cicd-jenkins.wip/README-Jenkins.md#deploying-step-3-networks-hub-and-spoke)
