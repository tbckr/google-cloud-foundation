...
| Name | Description |
|------|-------------|
| cicd\_project\_id | Project where the [CI/CD Pipeline](/_3rdparty/docs/GLOSSARY.md#foundation-cicd-pipeline) (Jenkins Agents and terraform builder container image) reside. |
